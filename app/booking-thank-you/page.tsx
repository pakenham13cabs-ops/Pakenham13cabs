      ...
      <main>
        <section className="inner-hero booking-hero">
          <div className="shell centered">
            ...
            <h1>
              Thank you for <strong>booking</strong>
            </h1>

            <p>
              We have received your taxi request and our team will call or SMS
        ...
        <section className="section">
          <div className="shell centered thank-you-card">
            ...
            <p>
              Online requests are not confirmed until you hear from our team.
              If your pickup is urgent, call us now and quote the details you
              submitted.
            </p>

            <div className="success-actions">
              <a className="button button-gold" href={PHONE_HREF}>
                Call {PHONE_DISPLAY}
              </a>
